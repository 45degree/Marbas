...
class MouseEvent : public Event {
 ...
 public:
  ...
  [[nodiscard]] std::tuple<float, float> GetPos() const noexcept { return std::make_tuple(x, y); }
...
class MouseButtonEvent : public MouseEvent {
 ...
 public:
  [[nodiscard]] int GetButton() const noexcept { return button; }
...
class MouseScrolledEvent : public MouseEvent {
 ...
 public:
  [[nodiscard]] float GetXOffset() const noexcept { return xoffset; }

  [[nodiscard]] float GetYOffset() const noexcept { return yoffset; }
